...
THEMES = {
    CANDY: {
        ...
        'goods': {'weed': 'Gum', 'hash': 'Jelly beans',
                  'acid': 'Chocolate', 'cocaine': 'Rock candy'},
        'places': {'docks': 'Cafeteria', 'uptown': 'Gym',
                   'suburbs': 'Library', 'station': 'Playground'},
        'hp': 'Energy',
        'owed': 'owe',
        'loan': 'Sibling',
    ...
    MATURE: {
        ...
        'goods': {'weed': 'Weed', 'hash': 'Hash',
                  'acid': 'Acid', 'cocaine': 'Cocaine'},
        'places': {'docks': 'Docks', 'uptown': 'Uptown',
                   'suburbs': 'Suburbs', 'station': 'Station'},
        'hp': 'HP',
        'owed': 'debt',
        'loan': 'Loan',
