...
THEMES = {
    CANDY: {
        ...
        'goods': {'ludes': 'Gumdrops', 'weed': 'Gum',
                  'speed': 'Pop rocks', 'peyote': 'Sherbet',
                  'hash': 'Jellies', 'mushrooms': 'Cookies',
                  'mda': 'Fizzers', 'opium': 'Nougat',
                  'acid': 'Chocolate', 'ketamine': 'Licorice',
                  'meth': 'Sour keys', 'oxy': 'Mints',
                  'pcp': 'Fudge', 'heroin': 'Toffee',
                  'crystal': 'Floss', 'cocaine': 'Humbugs'},
        'icons': {'ludes': '\N{DANGO}', 'weed': '\N{BUBBLE TEA}',
                  'speed': '\N{POPCORN}', 'peyote': '\N{SHAVED ICE}',
                  'hash': '\N{CANDY}', 'mushrooms': '\N{COOKIE}',
                  'mda': '\N{SOFT ICE CREAM}', 'opium': '\N{HONEY POT}',
                  'acid': '\N{CHOCOLATE BAR}', 'ketamine': '\N{CUPCAKE}',
                  'meth': '\N{DOUGHNUT}', 'oxy': '\N{LOLLIPOP}',
                  'pcp': '\N{PRETZEL}', 'heroin': '\N{CUSTARD}',
                  'crystal': '\N{STRAWBERRY}', 'cocaine': '\N{SHORTCAKE}'},
    ...
    MATURE: {
        ...
        'goods': {'ludes': 'Ludes', 'weed': 'Weed',
                  'speed': 'Speed', 'peyote': 'Peyote',
                  'hash': 'Hash', 'mushrooms': 'Shrooms',
                  'mda': 'MDA', 'opium': 'Opium',
                  'acid': 'Acid', 'ketamine': 'Ket',
                  'meth': 'Meth', 'oxy': 'Oxy',
                  'pcp': 'PCP', 'heroin': 'Heroin',
                  'crystal': 'Crystal', 'cocaine': 'Coke'},
