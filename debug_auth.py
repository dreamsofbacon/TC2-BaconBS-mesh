...
result = authenticate('arthur8734', '***REMOVED-PASSWORD***', 'fe80::7cf7:5bd9:8514:3abd')
print('Login result:', result)

# Test registration for a new user
result2 = authenticate('new:testuser999', '***REMOVED-PASSWORD***', 'fe80::7cf7:5bd9:8514:3abd')
